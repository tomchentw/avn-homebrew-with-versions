...
function _isVersionSatisfies(version, mNumber) {
  if ((0, _semver.satisfies)(version, mNumber)) {
    return true;
  }
  if ((0, _semver.valid)(mNumber) && (0, _semver.major)(version) === (0, _semver.major)(mNumber)) {
    return (0, _semver.major)(version) !== 0 || (0, _semver.minor)(version) === (0, _semver.minor)(mNumber);
  }
  return false;
}
